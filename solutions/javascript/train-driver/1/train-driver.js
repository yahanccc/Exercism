...
export function fixListOfWagons(ids) {
  const [id1, id2, ... restIds] = ids
  return [...restIds, id1, id2];
...
export function correctListOfWagons(ids, missingWagons) {
  const [id1, ...restIds] = ids
  return [id1, ...missingWagons, ...restIds];
}
...
export function separateTimeOfArrival(information) {
  const {timeOfArrival, ...restInfo} = information;
  return [ timeOfArrival, restInfo ]
}
